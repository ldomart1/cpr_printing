...
DEFAULT_ORIGIN_Z = -100.0

# Geometry
DEFAULT_ORDER = 1              # number of octet unit cells along cube edge
DEFAULT_PITCH_MM = 13.0           # octet strut length (FCC nearest-neighbor distance)
...
# Extrusion
DEFAULT_EXTRUSION_PER_MM = 0.00   # U mm per mm of printed path; set >0 to enable U extrusion
...
if __name__ == "__main__":
    ap = argparse.ArgumentParser(
        description=(
            ...
            "with exact tip tracking and soft tangent alignment. Physical tip kinematics are preserved; "
            "attack-direction azimuth can be remapped (default +180 deg). Includes per-pass U pressure "
            "preload/release and dwell timing."
        )
    )
